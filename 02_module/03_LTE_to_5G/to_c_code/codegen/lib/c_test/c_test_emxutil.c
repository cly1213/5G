...
/*
 * Arguments    : nrULSCHDecoder *pStruct
 * Return Type  : void
 */
void emxFreeStruct_nrULSCHDecoder(nrULSCHDecoder *pStruct)
{
  emxFreeStruct_cell_7(&pStruct->pCWSoftBuffer);
}
...
{
  emxFree_int32_T(&pStruct->offsetWeight);
  emxFree_int32_T(&pStruct->columnIndexMap);
}
 ...
 * Return Type  : void
 */
void emxInitStruct_nrULSCHDecoder(nrULSCHDecoder *pStruct)
{
  emxInitStruct_cell_7(&pStruct->pCWSoftBuffer);
}
...
{
  emxInit_int32_T(&pStruct->offsetWeight, 1);
  emxInit_int32_T(&pStruct->columnIndexMap, 1);
}
...
/*
 * File trailer for c_test_emxutil.c
 *
 * [EOF]
 */
