...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&c_test_atexit);
  /* Module initialization. */
  c_test_initialize();
  /* Dispatch the entry-point. */
  unsafe_c_test_mexFunction(nlhs, plhs, nrhs, prhs);
  /* Module termination. */
  c_test_terminate();
}
                               ...
                               const mxArray *prhs[2])
{
  ...
  /* Call the function. */
  c_test_api(prhs, &outputs);
  /* Copy over outputs to the caller. */
  emlrtReturnArrays(1, &plhs[0], &outputs);
}

/*
 * File trailer for _coder_c_test_mex.c
 *
 * [EOF]
 */
