function [simParameters] = pdschLinkDefaultParms()

    simParameters = [];             % Clear simParameters variable
    simParameters.SNRIn = 0;
    ...
    simParameters.PDSCH.Xoh_PDSCH = 0;              % The Xoh-PDSCH overhead value is taken to be 0 here
    ...
    if simParameters.PDSCH.NLayers > 4              % Multicodeword transmission
        simParameters.PDSCH.ncw = 2;                                        % Number of codewords
        ...
        simParameters.PDSCH.ncw = 1;                                        % Number of codewords
