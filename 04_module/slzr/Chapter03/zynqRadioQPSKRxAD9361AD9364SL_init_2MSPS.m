function SimParams = zynqRadioQPSKRxAD9361AD9364SL_init_2MSPS
...
SimParams.RadioFrontEndSampleRate = 2e6;   % <-- sample rate = 2 MSPS; this is the only change to the shipping demo 
